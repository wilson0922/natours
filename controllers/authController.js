...
exports.login = catchAsync(async (req, res, next) => {
  ...
  // ('abcd1234'==='$2a$12$6eAvy0dNx/svtVN9oQBrJOlcD5fn6UX.NN6pii6mFAIJBROewb7tK')
...
exports.updatePassword = catchAsync(async (req, res, next) => {
  ...
  // 2) Check if POSTED current password is corrected
